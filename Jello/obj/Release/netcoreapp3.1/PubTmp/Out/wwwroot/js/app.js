...
JelloNamespace.namespace("Local").Doit = (function () {
  var start = function () {};
...
JelloNamespace.namespace("Utils").Alert = (function () {
  var start = function () {
    $("#alert-success")
      .fadeIn(1000)
      .delay(3000)
...
JelloNamespace.namespace("Utils").Delete = (function () {
  var start = function () {
...
JelloNamespace.namespace("Utils").Misc = (function () {
  var start = function () {
...
JelloNamespace.namespace("Utils").Import = (function () {
  var start = function () {
...
JelloNamespace.namespace("Utils").Typeahead = (function () {
...
$(function () {
  JelloNamespace.Utils.Alert.start();
  JelloNamespace.Utils.Misc.start();
  JelloNamespace.Utils.Delete.start();
  JelloNamespace.Utils.Typeahead.start();
});
